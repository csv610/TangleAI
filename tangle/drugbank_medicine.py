...
if __name__ == "__main__":
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "user",
                "content": f"Provide comprehensive pharmaceutical information about {medicine_name}. Include drug type, approval status, chemical properties, indications, pharmacodynamics, side effects, dosage forms, and any relevant clinical data."
            }
        ],
        response_format={
            "type": "json_schema",
    ...
    medicine = MedicineInfo.model_validate_json(completion.choices[0].message.content)
